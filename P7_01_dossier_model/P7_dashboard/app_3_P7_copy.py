...
sb = st.sidebar
sb.image(URL+'/Pretadepenser.png')
...
list = "100002, 100003,100004,100005,100006,100007,100008,100009,100010,100011,100012"
...
sb.image(URL+"../P7_api/feature_importance.png")
...
if (numclient !=""):
    ...
    col2.image(URL+'../P7_dashboard/feature_importance_'+str(numclient)+'.png')
  ...
  # col3.write("[nomenclature]("+ URL + "../P7_dashboard/nomenclature.html)")
  #
  ...
  #     id = response.read().decode('utf-8')
  #     col4.image(URL+'../P7_dashboard/'+id+'.png')


    # modele_global_
    #col5.image(URL + '../P7_api/modele_global_' + str(numclient) + '.png')